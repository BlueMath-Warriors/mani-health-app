...
const Footer = () => {
  ...
  return (
    <div
      className={`${cookieAccepted? "flex" : "hidden"} bg-[#403D39] text-white flex flex-col items-center font-normal text-[13px] lg:text-sm px-[25px] py-[60px] lg:py-0 lg:pb-0 lg:pt-[100px]`}
    >
