...
const ClientTypeCard = ({
  ...
  return (
    <div
      ...
      className="flex cursor-pointer w-full flex-col items-center justify-start p-4 pt-11 bg-[#FAF4E6] min-w-[282px] max-w-[282px] h-[380px] rounded-lg text-center client-type-card"
    >
