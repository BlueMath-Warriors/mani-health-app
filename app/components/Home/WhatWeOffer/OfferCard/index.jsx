...
const OfferCard = ({ image, title, caption, link = "#" }) => {
  return (
    <div className="flex col-span-1 flex-col w-full max-w-md  min-[980px]:max-w-[360px] min-w-60 bg-white cursor-pointer custom-transition group ">
      <div
      ...
      <div className="p-4 flex flex-col items-center text-center min-[980px]:text-left offer-card-shadow rounded-b-lg">
        ...
        <Button
          ...
          className="!text-base !py-2 !px-4 min-[980px]:mr-auto "
        >
          Learn More
        </Button>
      </div>
