...
const DurableMedicalEquipmentSection = () => {
  return (
    <div className="flex justify-center items-center bg-primary/10 px-5 sm:px-48 tablet:px-20">
      <div className="flex flex-wrap min-[1300px]:grid-cols-3 max-w-[1300px]">
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3 sm:h-[369px] flex flex-col justify-center py-[60px]">
        ...
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3 sm:h-[369px] bg-primary text-white font-semibold py-[60px] px-[50px]">
        ...
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3 sm:h-[369px] font-semibold py-[60px] px-[50px]">
        ...
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3  sm:h-[369px] max-h-[300px] sm:max-h-[369px]">
          <Image
        ...
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3  sm:h-[369px] bg-white font-semibold py-[60px] px-[50px] z-[1]">
        ...
        <div className="w-full tablet:w-1/2 min-[1300px]:w-1/3  sm:h-[369px]">
          <Image
